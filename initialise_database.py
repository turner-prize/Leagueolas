...
from models import CreateSession, Gameweeks, Players, Fixtures, PlTeams,PlFixtures
import config
import requests
...
def populateFixtures(): 
    r = requests.get(f"https://fantasy.premierleague.com/api/leagues-h2h-matches/league/{config.LeagueCode}/?page={i}")
    data = r.json()
